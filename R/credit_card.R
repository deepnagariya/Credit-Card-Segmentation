rm(list=ls(all=T))
setwd("C:/Users/deepn/Desktop/Project")
...
#In missing value analysis KNN imputation is utilized with accurate value compared to mean and median 
#I choose KNN imputation method to treat with missing values
...
write.csv(cluster_profiling2,'cluster_profilingFinal.csv')
